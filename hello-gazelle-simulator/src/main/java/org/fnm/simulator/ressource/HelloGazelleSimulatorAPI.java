...
import org.fnm.simulator.HelloGazelleSimulationService;
...
@Path("")
public class HelloGazelleSimulatorAPI implements SimulationAPI {
    ...
    public Response getSimulationSequences() {
        ...
        SimulationSequence clientCredentialSequence = simulationService.getHelloGazelleSimulationSequence();
        ...
        try {
            ...
            Response.ResponseBuilder builder = Response.ok(
                    ...
                    List.of(clientCredentialSequenceDTO)));
    ...
    public Response getSimulationSequencesChecksum() {
        CRC32 crc = new CRC32();
        crc.update(simulationService.getHelloGazelleSimulationSequence().hashCode());
